...
void Direct3DBase::HandleDeviceLost()
{
	...
	m_movementBounds.Width = 0;
	m_movementBounds.Height = 0;
	m_swapChain = nullptr;
...
{
	m_movementBounds = m_window->Bounds;

	// Calculate the necessary swap chain and render target size in pixels.
	m_renderTargetSize.Width = ConvertDipsToPixels(m_movementBounds.Width);
	m_renderTargetSize.Height = ConvertDipsToPixels(m_movementBounds.Height);
...
{
	if (m_window->Bounds.Width  != m_movementBounds.Width ||
		m_window->Bounds.Height != m_movementBounds.Height)
	{
