...
public:
	...
	virtual void Update(float timeTotal, float timeDelta);	// Should be called first in children update overrides.
	...
	// For increasing the speed of the game incrementally.
	float getFPS();
	void setFPS(float multiplier);
